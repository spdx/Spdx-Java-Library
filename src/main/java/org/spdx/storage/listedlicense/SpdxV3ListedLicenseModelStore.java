...
public class SpdxV3ListedLicenseModelStore implements IModelStore {
	...
	static {
		// Licenses
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_SIMPLE_LICENSING_LICENSE_TEXT);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_NAME);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_STANDARD_LICENSE_HEADER);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_IS_OSI_APPROVED);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_IS_FSF_LIBRE);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_IS_DEPRECATED_LICENSE_ID);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_DEPRECATED_VERSION);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_COMMENT);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_SEE_ALSO);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_STANDARD_LICENSE_TEMPLATE);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_LICENSE_XML);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_OBSOLETED_BY);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_LIST_VERSION_ADDED);
		// Exceptions
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_ADDITION_TEXT);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_STANDARD_ADDITION_TEMPLATE);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_IS_DEPRECATED_ADDITION_ID);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_DEPRECATED_VERSION);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_COMMENT);
		SUPPORTED_V3_DESCRIPTORS.add(SpdxConstantsV3.PROP_EXPANDED_LICENSING_SEE_ALSO);
	...
	public Optional<TypedValue> getTypedValue(String objectUri)
		...
		switch (baseTypedValue.get().getType()) {
			case SpdxConstantsCompatV2.CLASS_SPDX_LISTED_LICENSE:
				return Optional.of(new TypedValue(objectUri, SpdxConstantsV3.EXPANDED_LICENSING_EXPANDED_LICENSING_LISTED_LICENSE, SpdxConstantsV3.MODEL_SPEC_VERSION));
			case SpdxConstantsCompatV2.CLASS_SPDX_LISTED_LICENSE_EXCEPTION:
				return Optional.of(new TypedValue(objectUri, SpdxConstantsV3.EXPANDED_LICENSING_EXPANDED_LICENSING_LISTED_LICENSE_EXCEPTION, SpdxConstantsV3.MODEL_SPEC_VERSION));
