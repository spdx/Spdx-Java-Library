...
/**
 * Collection of elements stored in an SPDX version 2 ModelStore
 * 
 * @author Gary O'Neall
 *
 */
public class ModelCollectionV2<T extends Object> implements Collection<Object> {
	 ...
	 */
	public ModelCollectionV2(IModelStore modelStore, String documentUri, String id, PropertyDescriptor propertyDescriptor,
