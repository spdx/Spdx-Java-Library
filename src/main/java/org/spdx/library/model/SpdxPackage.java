...
/**
 * A Package represents a collection of software files that are delivered as a single functional
 * component.
 *
 * @author Gary O'Neall
 */
public class SpdxPackage extends SpdxItem implements Comparable<SpdxPackage> {
  ...
  public SpdxPackage() throws InvalidSPDXAnalysisException {
    super();
    files =
        new RelatedElementCollection(
            this, RelationshipType.CONTAINS, SpdxConstants.CLASS_SPDX_FILE);
  }
  ...
  protected SpdxPackage(SpdxPackageBuilder spdxPackageBuilder) throws InvalidSPDXAnalysisException {
    this(
        spdxPackageBuilder.modelStore,
        spdxPackageBuilder.documentUri,
        spdxPackageBuilder.id,
        spdxPackageBuilder.copyManager,
        true);
    setFilesAnalyzed(
        spdxPackageBuilder.filesAnalyzed); // this must be done first since it impact validation
  ...
  public boolean isFilesAnalyzed() throws InvalidSPDXAnalysisException {
    Optional<Boolean> filesAnalyzed =
        getBooleanPropertyValue(SpdxConstants.PROP_PACKAGE_FILES_ANALYZED);
   ...
   */
  public SpdxPackage setFilesAnalyzed(@Nullable Boolean filesAnalyzed)
      throws InvalidSPDXAnalysisException {
  ...
  /**
   * @param builtDate This field provides a place for recording the actual date the package was
   *     built.
   * @throws InvalidSPDXAnalysisException
   */
  public void setBuiltDate(String builtDate) throws InvalidSPDXAnalysisException {
    if (strict
        && Objects.nonNull(builtDate)
        && Objects.nonNull(SpdxVerificationHelper.verifyDate(builtDate))) {
  ...
  public void setReleaseDate(String releaseDate) throws InvalidSPDXAnalysisException {
    if (strict
        && Objects.nonNull(releaseDate)
        && Objects.nonNull(SpdxVerificationHelper.verifyDate(releaseDate))) {
  ...
  /**
   * @return This field provides a place for recording the end of the support period for a package
   *     from the supplier.
   * @throws InvalidSPDXAnalysisException
   */
  ...
  /**
   * @param validUntilDate This field provides a place for recording the end of the support period
   *     for a package from the supplier.
   * @throws InvalidSPDXAnalysisException
   */
  public void setValidUntilDate(String validUntilDate) throws InvalidSPDXAnalysisException {
    if (strict
        && Objects.nonNull(validUntilDate)
        && Objects.nonNull(SpdxVerificationHelper.verifyDate(validUntilDate))) {
  ...
  public @Nullable AnyLicenseInfo getLicenseDeclared() throws InvalidSPDXAnalysisException {
    Optional<AnyLicenseInfo> retval =
        getAnyLicenseInfoPropertyValue(SpdxConstants.PROP_PACKAGE_DECLARED_LICENSE);
    if (retval.isPresent()) {
      return retval.get();
    } else {
   ...
   * @throws InvalidSPDXAnalysisException
   */
  public SpdxPackage setLicenseDeclared(@Nullable AnyLicenseInfo licenseDeclared)
      throws InvalidSPDXAnalysisException {
  ...
  public Collection<Checksum> getChecksums() throws InvalidSPDXAnalysisException {
    return (Collection<Checksum>)
        (Collection<?>)
            this.getObjectPropertyValueSet(SpdxConstants.PROP_PACKAGE_CHECKSUM, Checksum.class);
  }
  ...
  public Optional<SpdxPackageVerificationCode> getPackageVerificationCode()
    ...
    if (!(retval.get() instanceof SpdxPackageVerificationCode)) {
      throw new InvalidSPDXAnalysisException(
          "Invalid type - expecting SpdxVerificationCode, type was "
              + retval.get().getClass().toString());
    }
  ...
  public Collection<ExternalRef> getExternalRefs() throws InvalidSPDXAnalysisException {
    return (Collection<ExternalRef>)
        (Collection<?>)
            this.getObjectPropertyValueSet(SpdxConstants.PROP_EXTERNAL_REF, ExternalRef.class);
  }
  ...
  /**
   * @return provides information about the primary purpose of the package. Package Purpose is
   *     intrinsic to how the package is being used rather than the content of the package.
   * @throws InvalidSPDXAnalysisException
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * @param purpose provides information about the primary purpose of the package. Package Purpose
   *     is intrinsic to how the package is being used rather than the content of the package.
   * @throws InvalidSPDXAnalysisException
   */
  ...
  protected List<String> _verify(Set<String> verifiedIds, String specVersion) {
    ...
    try {
      verifyLicenseInfosInFiles(
          getLicenseInfoFromFiles(), filesAnalyzed, pkgName, verifiedIds, retval, specVersion);
    } catch (InvalidSPDXAnalysisException e) {
    ...
    try {
      if (getFiles().size() !=0 && !filesAnalyzed) {
        retval.add(
            "Warning: Found analyzed files for package "
                + pkgName
                + " when analyzedFiles is set to false.");
      }
    ...
    try {
      ...
      if (date.isPresent()) {
        ...
        if (Version.versionLessThan(specVersion, Version.TWO_POINT_THREE_VERSION)) {
          retval.add(
              "Built date is not supported prior to release " + Version.TWO_POINT_THREE_VERSION);
        }
      }
    } catch (InvalidSPDXAnalysisException e) {
    ...
    try {
      ...
      if (date.isPresent()) {
        ...
        if (Version.versionLessThan(specVersion, Version.TWO_POINT_THREE_VERSION)) {
          retval.add(
              "Release date is not supported prior to release " + Version.TWO_POINT_THREE_VERSION);
        }
      }
    } catch (InvalidSPDXAnalysisException e) {
    ...
    try {
      ...
      if (date.isPresent()) {
        ...
        if (Version.versionLessThan(specVersion, Version.TWO_POINT_THREE_VERSION)) {
          retval.add(
              "Valid until date is not supported prior to release "
    ...
    try {
      ...
      if (purpose.isPresent()
          && Version.versionLessThan(specVersion, Version.TWO_POINT_THREE_VERSION)) {
        retval.add(
            "Primary purpose is not supported prior to release " + Version.TWO_POINT_THREE_VERSION);
      }
    } catch (InvalidSPDXAnalysisException e) {
  ...
  private void verifyLicenseInfosInFiles(
  ...
  /**
   * @return the Sha1 checksum value for this package, or a blank string if no sha1 checksum has
   *     been set
   * @throws InvalidSPDXAnalysisException
   */
  ...
  public static class SpdxPackageBuilder {
    ...
    Collection<AnyLicenseInfo> licenseInfosFromFile =
        new ArrayList<>(); // optinal if isFilesAnalyzed is true
    ...
    Collection<SpdxFile> files = new ArrayList<SpdxFile>(); // optional if isFilesAnalyzed is true
    String homepage = null;
    String originator = null;
    String pacakgeFileName = null;
    SpdxPackageVerificationCode packageVerificationCode =
        null; // optional if isFilesAnalyzed is true
    ...
    /**
     * Build an SpdxPackage with the required parameters if isFilesAnalyzed is false - note
     * isFilesAnalyzed must be explicitly set to false
     *
     ...
     * @return this to continue the build
     */
    public SpdxPackageBuilder setLicenseInfosFromFile(
        Collection<AnyLicenseInfo> licenseInfosFromFile) {
     ...
     * @return this to continue the build
     */
    public SpdxPackageBuilder setPackageVerificationCode(
        SpdxPackageVerificationCode packageVerificationCode) {
    ...
    /**
     * @param filesAnalyzed if true, files were analyzed for this package - add additional required
     *     parameters files, verificationCode and licenseInfosFromFile
     * @return this to continue the build
     */
    ...
    /**
     * @param purpose Package Purpose is intrinsic to how the package is being used rather than the
    ...
    /**
     * @param releaseDate This field provides a place for recording the date the package was
     *     released.
     * @return this to continue the build
     */
