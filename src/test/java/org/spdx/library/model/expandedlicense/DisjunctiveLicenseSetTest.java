...
import org.spdx.library.model.expandedlicense.DisjunctiveLicenseSet.DisjunctiveLicenseSetBuilder;
...
public class DisjunctiveLicenseSetTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.expandedlicense.DisjunctiveLicenseSet#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.expandedlicense.DisjunctiveLicenseSet#getType()}.
	 */
	public void testGetType() throws InvalidSPDXAnalysisException {
		DisjunctiveLicenseSet testDisjunctiveLicenseSet = builderForDisjunctiveLicenseSetTests(modelStore, TEST_OBJECT_URI, copyManager).build();
		assertEquals("ExpandedLicense.DisjunctiveLicenseSet", testDisjunctiveLicenseSet.getType());
	}

	/**
	 * Test method for {@link org.spdx.library.model.expandedlicense.DisjunctiveLicenseSet#toString()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.expandedlicense.DisjunctiveLicenseSet#Element(org.spdx.library.model.expandedlicense.DisjunctiveLicenseSet.DisjunctiveLicenseSetBuilder)}.
	 */
