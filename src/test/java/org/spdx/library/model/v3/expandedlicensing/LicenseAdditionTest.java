...
public class LicenseAdditionTest extends TestCase {
	...
	static final String LICENSE_XML_TEST_VALUE = "test licenseXml";
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#getType()}.
	 */
	public void testGetType() throws InvalidSPDXAnalysisException {
		LicenseAddition testLicenseAddition = builderForLicenseAdditionTests(modelStore, TEST_OBJECT_URI, copyManager).build();
		assertEquals("ExpandedLicensing.LicenseAddition", testLicenseAddition.getType());
	}

	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#toString()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#Element(org.spdx.library.model.v3.expandedlicensing.LicenseAddition.LicenseAdditionBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#setIsDeprecatedAdditionId}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#setStandardAdditionTemplate}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#setObsoletedBy}.
	 */
	public void testLicenseAdditionsetObsoletedBy() throws InvalidSPDXAnalysisException {
		LicenseAddition testLicenseAddition = builderForLicenseAdditionTests(modelStore, TEST_OBJECT_URI, copyManager).build();
		assertEquals(Optional.of(OBSOLETED_BY_TEST_VALUE), testLicenseAddition.getObsoletedBy());
		testLicenseAddition.setObsoletedBy("new obsoletedBy value");
		assertEquals(Optional.of("new obsoletedBy value"), testLicenseAddition.getObsoletedBy());
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#setLicenseXml}.
	 */
	public void testLicenseAdditionsetLicenseXml() throws InvalidSPDXAnalysisException {
		LicenseAddition testLicenseAddition = builderForLicenseAdditionTests(modelStore, TEST_OBJECT_URI, copyManager).build();
		assertEquals(Optional.of(LICENSE_XML_TEST_VALUE), testLicenseAddition.getLicenseXml());
		testLicenseAddition.setLicenseXml("new licenseXml value");
		assertEquals(Optional.of("new licenseXml value"), testLicenseAddition.getLicenseXml());
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.LicenseAddition#setAdditionText}.
	 */
