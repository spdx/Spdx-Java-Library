...
public class LicenseTest extends TestCase {
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#verify()}.
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#getType()}.
	 */
	public void testGetType() throws InvalidSPDXAnalysisException {
		License testLicense = builderForLicenseTests(modelStore, TEST_OBJECT_URI, copyManager).build();
		assertEquals("ExpandedLicensing.License", testLicense.getType());
	}

	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#toString()}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#Element(org.spdx.library.model.v3.expandedlicensing.License.LicenseBuilder)}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setIsFsfLibre}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setIsDeprecatedLicenseId}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setIsOsiApproved}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setObsoletedBy}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setStandardLicenseHeader}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setLicenseText}.
	 */
	...
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setLicenseXml}.
	 */
	public void testLicensesetLicenseXml() throws InvalidSPDXAnalysisException {
		License testLicense = builderForLicenseTests(modelStore, TEST_OBJECT_URI, copyManager).build();
		assertEquals(Optional.of(LICENSE_XML_TEST_VALUE), testLicense.getLicenseXml());
		testLicense.setLicenseXml("new licenseXml value");
		assertEquals(Optional.of("new licenseXml value"), testLicense.getLicenseXml());
	}
	
	/**
	 * Test method for {@link org.spdx.library.model.v3.expandedlicensing.License#setStandardLicenseTemplate}.
	 */
