...
public class LicenseExceptionTest extends TestCase {
	...
	public void testCreateResource() throws InvalidSPDXAnalysisException {
		...
		store.copyFrom(DefaultModelStore.getDefaultDocumentUri(), EXCEPTION_ID1, SpdxConstants.CLASS_SPDX_LICENSE_EXCEPTION, DefaultModelStore.getDefaultModelStore());
