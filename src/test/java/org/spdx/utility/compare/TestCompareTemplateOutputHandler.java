...
public class TestCompareTemplateOutputHandler {
	...
	static final String ADOBE_GLYPH_TEXT = DIR + File.separator + "Adobe-Glyph.txt";
	static final String ADOBE_GLYPH_TEMPLATE = DIR + File.separator + "Adobe-Glyph.template.txt";
	static final String AAL_TEXT = DIR + File.separator + "AAL.txt";
	static final String AAL_TEMPLATE = DIR + File.separator + "AAL.template.txt";
	static final String AFL_3_TEXT = DIR + File.separator + "AFL-3.0.txt";
	static final String AFL_3_TEMPLATE = DIR + File.separator + "AFL-3.0.template.txt";
	static final String BSDNETBSD_TEXT = DIR + File.separator + "BSD-2-Clause-NetBSD.txt";
	static final String BSDNETBSD_TEMPLATE = DIR + File.separator + "BSD-2-Clause-NetBSD.template.txt";
	static final String APACHE_1_0_TEXT = DIR + File.separator + "Apache-1.0.txt";
	static final String APACHE_1_0_TEMPLATE = DIR + File.separator + "Apache-1.0.template.txt";
	static final String BSD_2_CLAUSE_TEXT = DIR + File.separator + "BSD-2-Clause.txt";
	static final String BSD_2_CLAUSE_TEMPLATE = DIR + File.separator + "BSD-2-Clause.template.txt";
	static final String BSD_4_CLAUSE_UC_TEXT  = DIR + File.separator + "BSD-4-Clause-UC.txt";
	static final String BSD_4_CLAUSE_UC_TEMPLATE  = DIR + File.separator + "BSD-4-Clause-UC.template.txt";
	static final String BSD_4_CLAUSE_TEXT  = DIR + File.separator + "BSD-4-Clause.txt";
	static final String BSD_4_CLAUSE_TEMPLATE  = DIR + File.separator + "BSD-4-Clause.template.txt";
	static final String CROSSWORD_TEXT  = DIR + File.separator + "Crossword.txt";
	static final String CROSSWORD_TEMPLATE  = DIR + File.separator + "Crossword.template.txt";
	static final String DFSL_TEXT = DIR + File.separator + "D-FSL-1.0.txt";
	static final String DFSL_TEMPLATE = DIR + File.separator + "D-FSL-1.0.template.txt";
	static final String CONDOR_1_1_TEXT = DIR + File.separator + "Condor-1.1.txt";
	static final String CONDOR_1_1_TEMPLATE = DIR + File.separator + "Condor-1.1.template.txt";
	static final String ISC_TEXT = DIR + File.separator + "ISC.txt";
	static final String ISC_TEMPLATE = DIR + File.separator + "ISC.template.txt";
	static final String MPL_1_TEXT = DIR + File.separator + "MPL-1.0.txt";
	static final String MPL_1_TEMPLATE = DIR + File.separator + "MPL-1.0.template.txt";
	static final String RPSL_1_TEXT = DIR + File.separator + "RPSL-1.0.txt";
	static final String RPSL_1_TEMPLATE = DIR + File.separator + "RPSL-1.0.template.txt";
	static final String RSCPL_TEXT = DIR + File.separator + "RSCPL.txt";
	static final String RSCPL_TEMPLATE = DIR + File.separator + "RSCPL.template.txt";
	static final String HPND_TEXT = DIR + File.separator + "HPND.txt";
	static final String HPND_TEMPLATE = DIR + File.separator + "HPND.template.txt";
	static final String CECILL2_TEXT = DIR + File.separator + "CECILL-2.0.txt";
	static final String CECILL2_TEMPLATE = DIR + File.separator + "CECILL-2.0.template.txt";
	static final String BSD_1_CLAUSE_TEXT = DIR + File.separator + "BSD-1-Clause.txt";
	static final String BSD_1_CLAUSE_TEMPLATE = DIR + File.separator + "BSD-1-Clause.template.txt";
	static final String LPPL_1_3_A_TEXT = DIR + File.separator + "LPPL-1.3a.txt";
	static final String LPPL_1_3_A_TEMPLATE = DIR + File.separator + "LPPL-1.3a.template.txt";
	static final String LPPL_1_3_C_TEXT = DIR + File.separator + "LPPL-1.3c.txt";
	static final String LPPL_1_3_C_TEMPLATE = DIR + File.separator + "LPPL-1.3c.template.txt";
	static final String ODBL_1_TEXT = DIR + File.separator + "ODbL-1.0.txt";
	static final String ODBL_1_TEMPLATE = DIR + File.separator + "ODbL-1.0.template.txt";
	static final String SLEEPYCAT_TEXT = DIR + File.separator + "Sleepycat.txt";
	static final String SLEEPYCAT_TEMPLATE = DIR + File.separator + "Sleepycat.template.txt";
	static final String SSPL_1_0_TEXT = DIR + File.separator + "SSPL-1.0.txt";
	static final String SSPL_1_0_TEMPLATE = DIR + File.separator + "SSPL-1.0.template.txt";
	static final String AGPL_3_0_ONLY_TEXT = DIR + File.separator + "AGPL-3.0-only.txt";
	static final String AGPL_3_0_ONLY_TEMPLATE = DIR + File.separator + "AGPL-3.0-only.template.txt";
	...
	static final String BSD_2_CLAUSE_VIEW_TEXT = DIR + File.separator + "BSD-2-Clause-Views.txt";
	static final String BSD_2_CLAUSE_VIEW_TEMPLATE = DIR + File.separator + "BSD-2-Clause-Views.template.txt";
	...
	static final String GD_TEXT = DIR + File.separator + "GD.txt";
