...
public class PositiveIntegerRange extends ModelObject  {
	...
	public PositiveIntegerRange setEnd(@Nullable Integer end) throws InvalidSPDXAnalysisException {
		...
		if (isStrict() && Objects.nonNull(end) && end > 1) {
			throw new InvalidSPDXAnalysisException("end value " + end + " is greater than the maximum 1 in PositiveIntegerRange");
		}
	...
	public PositiveIntegerRange setBegin(@Nullable Integer begin) throws InvalidSPDXAnalysisException {
		...
		if (isStrict() && Objects.nonNull(begin) && begin > 1) {
			throw new InvalidSPDXAnalysisException("begin value " + begin + " is greater than the maximum 1 in PositiveIntegerRange");
		}
	...
	protected List<String> _verify(Set<String> verifiedIds, String specVersion, List<ProfileIdentifierType> profiles) {
		...
		try {
			...
			if (Objects.nonNull(end) && end > 1) {
				retval.add("end value " + end + " is greater than the maximum 1 in PositiveIntegerRange");
			}
		...
		try {
			...
			if (Objects.nonNull(begin) && begin > 1) {
				retval.add("begin value " + begin + " is greater than the maximum 1 in PositiveIntegerRange");
			}
		} catch (InvalidSPDXAnalysisException e) {
