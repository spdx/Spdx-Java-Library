...
import org.spdx.library.model.v3.core.MediaType;
...
public class SpdxFile extends SoftwareArtifact  {
	...
	public Optional<MediaType> getContentType() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstants.SOFTWARE_PROP_CONTENT_TYPE);
		if (retval.isPresent()) {
	 ...
	 */
	public SpdxFile setContentType(@Nullable MediaType contentType) throws InvalidSPDXAnalysisException {
	...
	public static class SpdxFileBuilder extends SoftwareArtifactBuilder {
		...
		**/
		public SpdxFileBuilder setContentType(MediaType contentType) {
