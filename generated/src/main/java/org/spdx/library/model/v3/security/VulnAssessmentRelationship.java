...
public class VulnAssessmentRelationship extends Relationship  {
	...
	public Optional<Agent> getSuppliedBy() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstants.SECURITY_PROP_SUPPLIED_BY);
		if (retval.isPresent()) {
	...
	public Optional<Element> getAssessedElement() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstants.SECURITY_PROP_ASSESSED_ELEMENT);
		if (retval.isPresent()) {
	...
	public static class VulnAssessmentRelationshipBuilder extends RelationshipBuilder {
		 ...
		 * @throws InvalidSPDXAnalysisException
		 */
		public VulnAssessmentRelationshipBuilder(ModelObject from) throws InvalidSPDXAnalysisException {
		 ...
		 * @param objectUri
		 */
		public VulnAssessmentRelationshipBuilder(ModelObject from, String objectUri) {
