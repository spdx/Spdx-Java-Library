...
public class VexNotAffectedVulnAssessmentRelationship extends VexVulnAssessmentRelationship  {
	...
	public Optional<DateTime> getImpactStatementTime() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstants.SECURITY_PROP_IMPACT_STATEMENT_TIME);
		if (retval.isPresent()) {
	 ...
	 */
	public VexNotAffectedVulnAssessmentRelationship setImpactStatementTime(@Nullable DateTime impactStatementTime) throws InvalidSPDXAnalysisException {
	...
	protected List<String> _verify(Set<String> verifiedIds, String specVersion, List<ProfileIdentifierType> profiles) {
		...
		Optional<DateTime> impactStatementTime;
		try {
			impactStatementTime = getImpactStatementTime();
			if (impactStatementTime.isPresent()) {
				retval.addAll(impactStatementTime.get().verify(verifiedIds, specVersion, profiles));
			}
	...
	public static class VexNotAffectedVulnAssessmentRelationshipBuilder extends VexVulnAssessmentRelationshipBuilder {
		...
		DateTime impactStatementTime = null;
		...
		**/
		public VexNotAffectedVulnAssessmentRelationshipBuilder setImpactStatementTime(DateTime impactStatementTime) {
