...
public class SoftwareArtifact extends Artifact  {
	...
	public Optional<AnyLicenseInfo> getConcludedLicense() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstants.SOFTWARE_PROP_CONCLUDED_LICENSE);
		if (retval.isPresent()) {
	...
	public Optional<AnyLicenseInfo> getDeclaredLicense() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstants.SOFTWARE_PROP_DECLARED_LICENSE);
		if (retval.isPresent()) {
			if (!(retval.get() instanceof AnyLicenseInfo)) {
				throw new InvalidSPDXAnalysisException("Incorrect type stored for ");
			}
	...
	public static class SoftwareArtifactBuilder extends ArtifactBuilder {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SoftwareArtifactBuilder setConcludedLicense(AnyLicenseInfo concludedLicense) {
		 ...
		 * @return this for chaining
		**/
		public SoftwareArtifactBuilder setDeclaredLicense(AnyLicenseInfo declaredLicense) {
		...
		**/
		 ...
		 * @return this for chaining
		**/
		public SoftwareArtifactBuilder setAttributionText(String attributionText) {
